package com.eurekatech.itlamath.big;

import android.os.Build;
import android.support.annotation.RequiresApi;

import com.eurekatech.itlamath.big.internal.AsinCalculator;
import com.eurekatech.itlamath.big.internal.CosCalculator;
import com.eurekatech.itlamath.big.internal.CoshCalculator;
import com.eurekatech.itlamath.big.internal.ExpCalculator;
import com.eurekatech.itlamath.big.internal.SinCalculator;
import com.eurekatech.itlamath.big.internal.SinhCalculator;
...
public class BigDecimalMath {
    ...
    @RequiresApi(api = Build.VERSION_CODES.N)
    static List<BigDecimal> getSpougeFactorialConstants(final int a) {
        synchronized (spougeFactorialConstantsCacheLock) {
            return spougeFactorialConstantsCache.computeIfAbsent(a, new Function<Integer, List<BigDecimal>>() {
                @Override
                public List<BigDecimal> apply(Integer key) {
